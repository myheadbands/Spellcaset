export const LEVELS = [
  { level: 1, name: "Grik the Goblin", hp: 40, isBoss: false, aiTier: "basic", spellIds: ["fire", "volcano"], introLine: "A ragged goblin darts from the smoke.", defeatLine: "Grik flees, dropping singed runes." },
  { level: 2, name: "Snag the Scout", hp: 47, isBoss: false, aiTier: "basic", spellIds: ["fire", "volcano"], introLine: "Snag whistles; embers swirl around the arena.", defeatLine: "Snag stumbles back into the ruins." },
  { level: 3, name: "Cinder the Ember", hp: 55, isBoss: false, aiTier: "basic", spellIds: ["fire", "volcano"], introLine: "Cinder steps forward, palms blazing.", defeatLine: "Cinder's flame sputters to ash." },
  { level: 4, name: "Pyra the Flameguard", hp: 68, isBoss: true, aiTier: "boss", spellIds: ["fire", "volcano", "steam"], unlockElement: "water", introLine: "The first gate opens. Pyra guards the spring sigil.", bossLine: "Pyra channels twin sigils; heat and mist converge.", defeatLine: "The spring sigil shatters free. You claim Water." },
  { level: 5, name: "Morwen the Witch", hp: 74, isBoss: false, aiTier: "basic", spellIds: ["steam", "fog", "water"], introLine: "Morwen paints fog circles on the floor.", defeatLine: "Morwen vanishes into her own mist." },
  { level: 6, name: "Drip the Danker", hp: 80, isBoss: false, aiTier: "basic", spellIds: ["water", "wave", "lake"], introLine: "Drip stomps, flooding the battleground.", defeatLine: "The flood recedes as Drip falls." },
  { level: 7, name: "Puddle", hp: 87, isBoss: false, aiTier: "adaptive", spellIds: ["wave", "rain", "lake"], introLine: "Puddle laughs and mirrors your stance.", defeatLine: "Puddle dissolves into harmless rain." },
  { level: 8, name: "Bogwart", hp: 95, isBoss: false, aiTier: "adaptive", spellIds: ["plant", "mud", "rain"], introLine: "Roots crawl up as Bogwart arrives.", defeatLine: "Bogwart sinks into the marsh." },
